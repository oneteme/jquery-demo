...
public class JQueryControllerH2 {
	...
	@GetMapping("employees/postgresql")
	...
	@GetMapping("customers/postgresql")
	...
	@GetMapping("shippers/postgresql")
	...
	@GetMapping("categories/postgresql")
	...
	@GetMapping("suppliers/postgresql")
	...
	@GetMapping("products/postgresql")
